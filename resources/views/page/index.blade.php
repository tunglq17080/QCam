...
<div class="app-content">
    ...
    <div class="s-skeleton s-skeleton--h-600 s-skeleton--bg-grey">
        <div class="owl-carousel primary-style-1" id="hero-slider">
            <div class="hero-slide hero-slide--1" style="background-image: url(../images/product/photographer-with-nikon-camera-1920x1080_7444-mm-90.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
            ...
            <div class="hero-slide hero-slide--2" style="background-image: url(../images/product/1209664.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="slider-content slider-content--animation">
            ...
            <div class="hero-slide hero-slide--3" style="background-image: url(../images/product/101-1013845_wallpaper-camera-smoke-photographer-lens-neon-smoke-walpaper.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="slider-content slider-content--animation">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                        ...
                        <a class="promotion" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img promotion__img" src="images/collection/1536134759000_dof_zone_1000x1000.jpg" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                        ...
                        <a class="promotion" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img promotion__img" src="images/collection/sonycam.jpg" alt=""></div>
                            <div class="promotion__content">
                                <div class="promotion__text-wrap">
                                    <div class="promotion__text-1">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                        ...
                        <a class="promotion" href="shop-side-version-2.html">
                            <div class="aspect aspect--bg-grey aspect--square">
                                ...
                                <img class="aspect__img promotion__img" src="images/collection/nkl-25468_1.jpg" alt=""></div>
                            <div class="promotion__content">
                                <div class="promotion__text-wrap">
                                    <div class="promotion__text-1">
                    ...
                    <div class="col-lg-12">
                        <div class="filter-category-container">
                            ...
                            <div class="filter__category-wrapper">
                                ...
                                <button class="btn filter__btn filter__btn--style-1" type="button" data-filter=".{{$categorie->slug}}">{{$categorie->name}}</button></div>
                            @endforeach
                        </div>
                        <div class="filter__grid-wrapper u-s-m-t-30">
                            <div class="row">
                                ...
                                @foreach ($products as $product)
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item {{$categorie->slug}}">
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            ...
                                            <span class="product-o__category">
                                                ...
                                                <a href="shop-side-version-2.html">{{$categorie->name}}</a></span>
                    ...
                    <div class="col-lg-6 col-md-6 u-s-m-b-30">
                        <div class="product-o product-o--radius product-o--hover-off u-h-100">
                                ...
                                <div class="product-o__action-wrap">
                                    <ul class="product-o__action-list">
                                        ...
                                        <li>
                                            ...
                                            <a data-modal="modal" data-id="{{$deal_of_day->id}}" class="submit-cart"  data-modal-id="#add-to-cart" data-tooltip="tooltip" data-placement="top" title="Add to Cart"><i class="fas fa-plus-circle"></i></a></li>
                                        <li>
                            ...
                            <span class="product-o__name">
                                ...
                                <a href="product-detail.html">{{$deal_of_day->name}}</a></span>
                            <div class="product-o__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>

                                <span class="product-o__review">(2)</span></div>

                            <span class="product-o__price">{{number_format($deal_of_day->unit_price)}} đ

                                <span class="product-o__discount">{{number_format($deal_of_day->unit_price)}} đ</span></span>
                        </div>
                    </div>
                    @endforeach
                </div>
    ...
    <!--====== Section 5 ======-->
    <div class="banner-bg" style="background: #f5f5f5 url(../images/product/ws_Photographer_1920x1080.jpg) repeat fixed center center;">
                        ...
                        <div class="u-s-m-b-30">
                            <div class="product-o product-o--hover-on">
                                    ...
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            ...
                                            <li>
                                                ...
                                                <a data-modal="modal" data-id="{{$new_arrival->id}}" class="submit-cart" data-modal-id="#add-to-cart" data-tooltip="tooltip" data-placement="top" title="Add to Cart"><i class="fas fa-plus-circle"></i></a></li>
                                            <li>
                                ...
                                <span class="product-o__name">
                                    ...
                                    <a href="product-detail.html">{{$new_arrival->name}}</a></span>
                                ...
                                <span class="product-o__price">{{number_format($new_arrival->unit_price)}} đ

                                    <span class="product-o__discount">{{number_format($new_arrival->unit_price)}} đ</span></span>
                            </div>
                        </div>
                        @endforeach
                    </div>
