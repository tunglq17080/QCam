<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li> <a class="waves-effect waves-dark" href="{{ route('admin.product') }}" aria-expanded="false"><i
                ...
                <li> <a class="waves-effect waves-dark" href="{{ route('admin.order') }}" aria-expanded="false"><i
                            class="fa fa-table"></i><span class="hide-menu">Tables Orders</span></a>
                </li>
                <li> <a class="waves-effect waves-dark" href="#" aria-expanded="false"><i
